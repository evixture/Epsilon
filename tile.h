...
struct TileData
{
	...
	TileData(int ch, TCODColor foregroundColor, TCODColor backgroundColor);
};
...
struct Destructible : public Tile //destructible type of tile that can be destroyed by various items
{
	...
	Destructible(std::vector<std::shared_ptr<TileData>> tileList, unsigned char transparentFlag, unsigned char walkableFlag, int strength); //constructor for destructible that takes character, colors, height, walkability, and strength
...
struct Stair : public Tile //stair type of tile that allows travel between floors
{
	...
	Stair(std::vector<std::shared_ptr<TileData>> tileList, unsigned char transparentFlag, unsigned char walkableFlag, int moveDistance); //constructor for stair that takes character, colors, height, walkability, and move distance
